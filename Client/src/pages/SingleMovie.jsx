...
const SingleMovie = () => {
   ...
   const getAllTheatres = async () => {
    try {
        ...
        console.log('Sending request with:', { movie: params.id, date });
        
        const response = await getAllTheatresByMovie({ movie: params.id, date });
        
        console.log('API Response:', response); // This will now show the actual error
        
        if (response.success) {
            setTheatres(response.data);
        } else {
            message.warning(response.message); // This will now show the backend error message
